export default function LoadingState({
  ...
  const content = (
    <div className="relative overflow-hidden rounded-3xl border border-[#dbe8ff] bg-white/90 px-8 py-10 text-center shadow-[0_22px_65px_rgba(10,43,110,0.12)]">
      <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#1f67ff] via-[#19b9c7] to-[#11c69a]" />
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#eff8ff]">
